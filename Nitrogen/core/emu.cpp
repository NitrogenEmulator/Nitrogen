...
void EMU_init(int lang)
{
	...
	*/
	...
	static const char* nickname = "Nitrogen"; //TODO: Add firmware cfg in settings
	fw_config.nickname_len = strlen(nickname);
	for(int i = 0 ; i < fw_config.nickname_len ; ++i)
		fw_config.nickname[i] = nickname[i];
    
	static const char* message = "Nitrogen makes you happy!";
...
static void Nitrogen_throttle(bool allowSleep = true, int forceFrameSkip = -1)
{
