...
#import "NitrogenAboutViewController.h"
#import "Twitter/Twitter.h"
#import "emu.h"

@interface NitrogenAboutViewController ()

@end

@implementation NitrogenAboutViewController
...
- (void)viewDidLoad
{
    ...
    aboutTitle.title = NSLocalizedString(@"ABOUT_NITROGEN", nil);
...
- (NSString *)tableView:(UITableView *)tableView  titleForHeaderInSection:(NSInteger)section
{
    ...
    switch (section)
    {
        case 0:
            ...
            break;
        case 1:
            sectionName = NSLocalizedString(@"ABOUT_NITROGEN", nil);
            break;
        default:
            sectionName = @"";
            break;
...
- (IBAction)sendTweet:(id)sender {
    ...
    //Preloaded message
    [tweetSheet setInitialText:@"I love playing games on my iOS device with #NitrogenEmulator"];
